...
def main():
    ...
    parser.add_argument('-ds', '--direction_string', required=False,
    ...
    if args.direction_string:
        ...
        pointing_string = putil.generate_position_string_for_chgcentre(ra = ra_centre,
                                                                dec = dec_centre)

        logger.info('Coordinate string for chgcentre: {0:s}'.format(pointing_string))

        sys.stdout.write(pointing_string) #Print would also work, but it adds \n automatically...
