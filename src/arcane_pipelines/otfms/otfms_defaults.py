...
_otfms_default_config_dict = {'ENV': {
    ...
    'delay_centre_Alt_t0' : ['0.0', False, 'float or None [degrees]'],
    'delay_centre_Az_t0' : ['0.0', False, 'float or None [degrees]'],
    't0' : ['0.0', False, 'float or none [UNIX timestamp]'],
    'calibrator_list': ['', False, 'comma separated list or none'],
    'flag_noise_diode': ['False', True, 'boolean'],
    'noise_diode_setup': ['', False, 'absolute path'],
