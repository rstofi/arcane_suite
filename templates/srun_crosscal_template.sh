...
singularity exec --bind /project/ls-mohr/MeerKAT:/MeerKAT ${CONTAINER} caracal -c crosscal.yml -ct singularity -sid /MeerKAT/singularity_containers/stimela_images_for_caracal/
